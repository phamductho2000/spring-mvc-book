                    ...
                    <tr>
                        ...
                        <td>
                            <div class="crud" style="text-align: center;">
                                <a href="<c:url value=""/>" style="margin-right: 8px"><i class="fa fa-info-circle"></i></a>
                                <a href="<c:url value=""/>" style="margin-right: 8px"><i class="fa fa-edit"></i></a>
                                <a href="<c:url value=""/>"><i class="fa fa-close"></i></a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
