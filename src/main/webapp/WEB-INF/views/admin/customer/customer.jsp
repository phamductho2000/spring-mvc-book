...
<div class="" style="margin-top: 30px">
        <div class="search-form" style="display: flex; justify-content: flex-end; height: 33px">
            <div class="item-flex2">
                <input type="text" id="inputCustomerName" placeholder="Nhập tên thành viên" class="form-control">
            </div>
            <div class="item-flex2">
                <button type="submit" class="btn btn-primary" onclick="searchCustomer()"><i class="fa fa-search" style="padding-right: 4px;"></i>Tìm kiếm</button>
            </div>
        </div>
</div>
            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <c:forEach var="item" items="${ListUser}">
                    <tr>
                        ...
                        <td>
                            <a href="/admin/customer/edit/${item.id}" class="btn btn-default btn-xs m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></a>
