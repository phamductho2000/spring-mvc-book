    ...
    <div class="search-form" style="display: flex; justify-content: space-around; height: 33px; padding-right: 9px">
            ...
            <div>
                <select class="form-control" name="status" id="s_status" style="width: 200px">
                    <option value="0" label="Chọn tình trạng"/>
                        <option value="1" label="Hết hàng">
                        <option value="2" label="Còn hàng">
                        <option value="3" label="Ngừng kinh doanh">
                    </option>
                </select>
            </div>
            <div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${item.status == 3}">
                            <td><span class="badge badge-dark">Ngừng kinh doanh</span></td>
                        </c:if>
                    <td>
