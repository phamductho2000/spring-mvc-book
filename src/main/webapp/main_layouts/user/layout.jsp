...
<head>
    ...
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="<c:url value='/resources/user/assets/css/bootstrap.min.css'/>">
...
<script src="<c:url value='/resources/user/assets/js/jquery.waypoints.min.js'/>"></script>
<script src="<c:url value='/resources/user/assets/js/superfish.min.js'/>"></script>
<script src="<c:url value='/resources/user/assets/js/owl.carousel.min.js'/>"></script>
<script src="<c:url value='/resources/user/assets/js/bootstrap-input-spinner.js'/>"></script>
