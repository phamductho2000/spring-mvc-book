...
public class PublisherController {
    ...
    @RequestMapping(value = "/admin/home/publisher", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/admin/home/publisher/new", method = RequestMethod.GET)
    public ModelAndView addPage() {
        ModelAndView mav = new ModelAndView("admin_publisher_new", "publisher", new PublisherDTO());
        return mav;
    }

    @RequestMapping(value = "/admin/home/publisher/save", method = RequestMethod.POST)
    public String saveBook(@ModelAttribute("book") PublisherDTO publisher) {
        publisherService.save(publisher);
        return "redirect:/admin/home/publisher";
    }

    @RequestMapping(value = "/admin/home/publisher/edit/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/admin/home/publisher/update", method = RequestMethod.POST)
